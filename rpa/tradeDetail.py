...
if __name__ == '__main__':
    ee = ExcelRead(r'C:\rpa\历史交易-571912061410601-20190401-20190709.xls')
    # print(ee.getDataFromXls())
    # xlsReader = ExcelRead(xls_path)
    self.gv_3_trade_detail_json = ee.trans_xls_to_json()
    print("===trade detail in json: "+ self.gv_3_trade_detail_json)
